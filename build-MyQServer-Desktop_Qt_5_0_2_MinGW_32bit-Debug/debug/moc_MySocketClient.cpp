...
#include "../../pg208_web_project-master/src/MySocketClient.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_MySocketClient_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 46, 11)
    ...
    "MySocketClient\0error\0\0QTcpSocket::SocketError\0"
    "socketError\0"
};
...
void MySocketClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MySocketClient::*_t)(QTcpSocket::SocketError );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MySocketClient::error)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject MySocketClient::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_MySocketClient.data,
      qt_meta_data_MySocketClient,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MySocketClient.stringdata))
