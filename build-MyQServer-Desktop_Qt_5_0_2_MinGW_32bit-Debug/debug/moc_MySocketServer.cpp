...
#include "../../pg208_web_project-master/src/MySocketServer.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_MySocketServer_t, stringdata) + ofs \
...
const QMetaObject MySocketServer::staticMetaObject = {
    { &QTcpServer::staticMetaObject, qt_meta_stringdata_MySocketServer.data,
      qt_meta_data_MySocketServer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MySocketServer.stringdata))
